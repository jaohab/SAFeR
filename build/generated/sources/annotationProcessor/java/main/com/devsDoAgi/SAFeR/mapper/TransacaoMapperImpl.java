...
public class TransacaoMapperImpl implements TransacaoMapper {
    ...
    public TransacaoResponseDTO toResponseDTO(Transacao transacao) {
        ...
        transacaoResponseDTO.setTipoCartao( transacao.getTipoCartao() );
        transacaoResponseDTO.setCanalAtual( transacao.getCanalAtual() );
        transacaoResponseDTO.setCanalUsual( transacao.getCanalUsual() );
        transacaoResponseDTO.setTentativasErradasCVV( transacao.getTentativasErradasCVV() );
        transacaoResponseDTO.setTentativasErradasSenha( transacao.getTentativasErradasSenha() );
